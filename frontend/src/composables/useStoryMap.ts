...
import { storytellingTokens } from '../design/tokens'
  ...
  function upsertArc(maplibregl: Awaited<ReturnType<typeof loadMapLibre>>) {
    ...
    if (!instance.getSource(ARC_SOURCE_ID)) {
      ...
      instance.addLayer({
        ...
        filter: ['==', ['get', 'role'], 'arc'],
        paint: {
          'line-color': storytellingTokens.colors.secondary,
          'line-width': 3.5,
      ...
      instance.addLayer({
        ...
        paint: {
          'circle-radius': 7,
          'circle-color': storytellingTokens.colors.primary,
          'circle-stroke-color': storytellingTokens.colors.secondary,
      ...
      instance.addLayer({
        ...
        paint: {
          'circle-radius': 7,
          'circle-color': storytellingTokens.colors.secondary,
          'circle-stroke-color': storytellingTokens.colors.text,
          'circle-stroke-width': 2,
        },
      })
    } else {
